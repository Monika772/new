    ...
    <tbody>
       <tr>
         <td align="center">
           ...
           <table style="margin-bottom:0.0px;margin-left:auto;margin-right:auto;margin-top:0.0px;max-width:600.0px;min-width:370.0px;width:100.0%; background:url({{url('storage/app/email/OTP')}}/Email-Template.jpg); height:100%;" cellspacing="0" cellpadding="0" border="0" >
                <tbody >
                   ...
                   <tr style="text-align:center;height:90px;">
                      ...
                      <!-- <td style="font-size:27px; font-weight:600; color:#000; font-family: 'Lato', sans-serif;">
                   ...
                   <tr style="text-align:center;height:60px;font-size:23px; font-weight:500; color:#000;">
                    <td style="font-size:22px; font-weight:500; color:#000; font-family: 'Lato', sans-serif; padding:0 40px;">
                   Your Email OTP :&nbsp;<span style="color:#0096c0;font-weight:600;">{{$link}}</span> 
                    </td>
                 </tr>
