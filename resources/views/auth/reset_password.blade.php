...
<body class="hold-transition login-page">
    <div class="login-box">
        ...
        <div class="login-box-body">
            ...
            <form method="POST" action="{{ route('update_password') }}" onsubmit="return ValidateForm();">
                @csrf
                ...
                <div class="form-group has-feedback">
                    <input type="password" name="conform_password" required id="conform_password" class="form-control" placeholder="Confirm Password">
                    <span class="glyphicon glyphicon-lock form-control-feedback"></span>
                </div>
                <div class="form-group has-feedback">
                    <input type="hidden" name="code" class="form-control" value="{{ app('request')->input('code') }}">
                </div>
                <div class="row">
                    <!-- /.col -->
                    <div class="col-xs-4">
