<div class="modal-dialog modal-sm modal-dialog-centered" role="document">
    <form method="POST" action="{{url('category/store')}}" enctype="multipart/form-data" id="addCategory">
        @csrf
       <div class="modal-content">
            <div class="modal-header text-left">
                <span class="modal-heading">Add Category</span>
            ...
            <div class="modal-body p_15">
                <div class="form-group">
                    ...
                    <input type="text" name="name_en" class="form-control" placeholder="Category Name">
                </div>
                <div class="form-group">
                    <label for="">Category Name (HI)</label>
                    <input type="text" name="name_hindi" class="form-control" placeholder="Category Name">
                </div>
                ...
                <div class="form-group">
                    ...
                    <!-- <input type="file" name="image" class="form-control" placeholder="" id="filePhoto"> -->
                </div>
                <div class="form-group">
            ...
            <div class="modal-footer text-center">
                ...
                <button type="button" class="btn btn-primary" id="category_save">Save</button>
            </div>
        </div>
        </form> 
    </div>
